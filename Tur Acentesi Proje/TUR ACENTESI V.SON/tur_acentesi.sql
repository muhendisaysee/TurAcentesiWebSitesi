...
-- tur_acentes.dosya: ~2 rows (yaklaşık) tablosu için veriler indiriliyor
...
-- tur_acentes.grup: ~4 rows (yaklaşık) tablosu için veriler indiriliyor
...
-- tur_acentes.personel: ~4 rows (yaklaşık) tablosu için veriler indiriliyor
...
INSERT INTO `personel` (`personel_id`, `personel_adi_soyadi`, `personel_tel`, `acente_id`, `grup_id`, `bolum_id`, `personel_sifre`, `personel_kullanici`) VALUES
	(1, 'Volkan Üstekidağ', '5385678495', 1, 1, 1, '123', 'volkanustekidag'),
	(4, 'Tuba Günaçgün', '5312162545', 1, 1, 2, '123', 'tubagunacgun'),
	(6, 'Bekir Demir', '05435115565', 1, 6, 4, '123', 'bekirdemir'),
...
-- tur_acentes.tur: ~1 rows (yaklaşık) tablosu için veriler indiriliyor
...
-- tur_acentes.tur_musteri: ~1 rows (yaklaşık) tablosu için veriler indiriliyor
...
-- tur_acentes.tur_personel: ~2 rows (yaklaşık) tablosu için veriler indiriliyor
